  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <Clock className="w-8 h-8 text-primary-600 animate-spin" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900">Zeiterfassung</h1>
          <p className="text-sm text-neutral-500 mt-0.5">{activeUser?.name || activeUser?.email}</p>
        </div>
        <div className="flex items-center gap-2">
          <Link to="/time-logs/calendar" className="btn btn-secondary">
